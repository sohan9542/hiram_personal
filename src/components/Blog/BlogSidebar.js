    ...
    return (
        <div className="widget-area" id="secondary">
            ...
            <div className="widget widget_categories">
                ...
                <ul>
                    <li><Link to="/blog-1">Business</Link></li>
                    <li><Link to="/blog-1">Privacy</Link></li>
                    <li><Link to="/blog-1">Technology</Link></li>
                    <li><Link to="/blog-1">Tips</Link></li>
                    <li><Link to="/blog-1">Uncategorized</Link></li>
                </ul>
            </div>
            ...
            <div className="widget widget_tag_cloud">
                ...
                <div className="tagcloud">
                    <Link to="/blog-1">IT <span className="tag-link-count">(3)</span></Link>
